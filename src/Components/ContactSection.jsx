...
export default function ContactSection() {
    return (
        <div id='ContactMe' className="flex flex-col gap-32">
            ...
            <div className="flex justify-center gap-24">
                <a target="_blank" href="https://linkedin.com/in/brandonpieczka/">
                    <div className="size-32 bg-slate-700 flex items-center justify-center motion-safe:animate-bounce rounded-full">
                ...
                <a href="mailto:brandonpieczka@gmail.com" className='flex items-center text-lg hover:text-red-400 transition-colors'>
                    <div className="size-32 bg-slate-700 flex items-center justify-center motion-safe:animate-bounce rounded-full">
                        <svg className="w-20 h-20 bg-stone-800 rounded-lg" fill="white" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M2.003 5.884L10 9.882l7.997-3.998A2 2 0 0016 4H4a2 2 0 00-1.997 1.884z"></path><path d="M18 8.118l-8 4-8-4V14a2 2 0 002 2h12a2 2 0 002-2V8.118z"></path></svg>
                    </div>
                </a>
